            ...
            <div className="text-center space-y-6">
              ...
              >
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight">
                  Fuel Your{' '}
                  <span className="molten-text">Creative Journey</span>
                </h1>
                <p className="text-xl text-muted-foreground max-w-3xl mx-auto mt-4">
                  Purchase Embers to unlock premium features, boost your
                  projects, and accelerate your success on Forge.
                </p>
              </motion.div>
              ...
              <div className="space-y-6">
                <Card>
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground">
                      ...
                      advanced features, boost your projects&apos; visibility,
                ...
                <Card>
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground">
                      No, your Embers never expire. Once purchased, they remain
                ...
                <Card>
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground">
                      ...
                      you experience technical issues, please contact our
                      support team.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground">
                      Your current Ember balance is displayed in your profile
                      and dashboard. You can also view your transaction history
                      in account settings.
                    </p>
                  </CardContent>
                </Card>
