...
const allPosts = [
  ...
  },
  {
    ...
    excerpt:
      'Learn effective strategies for pricing your creative services to ensure fair compensation while remaining competitive.',
    coverImage:
      'https://images.pexels.com/photos/3785927/pexels-photo-3785927.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
  ...
  },
  {
    ...
    excerpt:
      'Tips and strategies for creating a portfolio that captures attention and showcases your unique skills.',
    coverImage:
  ...
  },
  {
    ...
    excerpt:
      'Understanding the psychological aspects of effective collaboration and how to overcome common challenges.',
    coverImage:
  ...
  },
  {
    ...
    excerpt:
      'Discover the latest AI tools that can help you streamline your creative process and boost productivity.',
    coverImage:
        ...
        <div className="container mx-auto max-w-7xl px-4 md:px-6">
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight">
              Insights from the{' '}
              <span className="molten-text">Creative Frontier</span>
            </h1>
            <p className="text-muted-foreground max-w-2xl text-lg">
              Explore articles, guides, and trends to help you grow your skills
              and navigate the creative landscape.
            </p>
          </div>
        </div>
      </section>
                    ...
                    <Card className="flex-1">
                      <CardContent className="p-6">
                        ...
                        <p className="text-muted-foreground mb-4 line-clamp-4">
                          ...
                          concept of skill exchange is undergoing a profound
                          transformation. Digital platforms are enabling people
                          to trade expertise across geographical boundaries,
                          creating new economic models. This article explores
                          how this shift is impacting traditional employment and
                          creating opportunities for those willing to embrace
                        ...
                        <div className="space-y-3">
                          <div className="flex items-center">
                            ...
                            <p className="text-sm">
                              The rise of platform-based skill marketplaces
                            </p>
                          </div>
                          <div className="flex items-center">
                            <div className="w-2 h-2 rounded-full bg-accent mr-2"></div>
                            <p className="text-sm">
                              How cryptocurrency is enabling peer-to-peer
                              compensation
                            </p>
                          </div>
                          <div className="flex items-center">
                            <div className="w-2 h-2 rounded-full bg-accent mr-2"></div>
                            <p className="text-sm">
                              The challenges of establishing trust in digital
                              exchanges
                            </p>
                          </div>
                        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  Subscribe to our newsletter for the latest articles, guides,
                  and insights.
                </p>
